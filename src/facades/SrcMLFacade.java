...
import extractorUtilities.SrcMLExtractor;
import paths.DynamicPaths;

public class SrcMLFacade extends ExtractionFacade {
...
//				moveFilesAndFoldersOfCommit.moveAllFromMap();
				...
				SrcMLExtractor extractor = new SrcMLExtractor(gitRepo.getCurrentCommitName(),
						gitRepo.getRootPath().replace("/projects_extracted", "") + "increments/"
...
//				SourceNavigatorExtractor extractor = new SourceNavigatorExtractor(gitRepo.getCurrentCommitName(),
//						gitRepo.getRootPath().replace("/projects_extracted", "") + "increments/"
//								+ gitRepo.getProjectName(),
//						gitRepo.getCurrentCommitName());
//				if (extractor.doExtraction("cpp")) {
