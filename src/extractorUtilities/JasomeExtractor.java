...
public class JasomeExtractor extends Extractor {
	...
	public JasomeExtractor() {
		// TODO Auto-generated constructor stub
	}
	
	public JasomeExtractor(String target, String rootPath, String projectPath) {
		this.target = target;
	...
	public ExtractionMethod getNewInstance(String target, String rootPath, String projectPath) {
		JasomeExtractor je = new JasomeExtractor(target, rootPath, projectPath);
		return je;
	}
...
//		language = checkLanguage();
		if (language != "none") {
			if (language.equals("java")) {
				String SRC_PATH = "/vagrant/ExtractorUtilities/project_extracted/" + RunConfiguration.SELECTED_COMMITS + "/";
				String[] java_command = { "../../Jasome/jasome-0.6.8-alpha/bin/jasome", "-o " + this.target + ".jasome", SRC_PATH + this.projectName + "/" + this.target };
...
//			read the list of file
		...
		ConsoleFactory.getConsole().run(command, null, null, this.target);
